...
axes(handles.axes8);
plot(PlotAxes_t1, record_dat1_show(1,:), '-^g');
hold on;
plot(PlotAxes_t1, record_dat1_show(2,:), '-sb');
plot(PlotAxes_t1, record_dat1_show(2,:), '-*r');
...
plot(PlotAxes_t2, record_dat2_show(2,:), '-*r');
...
plot(PlotAxes_t3, record_dat3_show(2,:), '-*r');
