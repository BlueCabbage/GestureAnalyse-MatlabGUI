...
for index = 1 : origin_size
    delta_origin_right_att(index, :) = delta_origin_right_att(index, :) * att_r2l;
    delta_origin_right_acc(index, :) = delta_origin_right_acc(index, :) * acc_r2l;
    delta_origin_right_gyro(index, :) = delta_origin_right_gyro(index, :) * att_r2l;
end
